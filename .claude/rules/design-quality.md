...
## Project-Specific: Whispering Lore

This is a dark folklore project with Nordic/Gothic themes:
- **Design System**: "Bone & Ash" — charcoal backgrounds (#0D0D0D), bone text (#D6D3C8), crimson accent (#991B1B)
- **Typography**: Cinzel (display), Lora (body)
- **Visual Direction**: Dark editorial with fog overlays, gothic arch motifs, rune scatter effects
- **Pages**: index (full hero), about, world, stories, bestiary
- **Reference**: See memory `design-system` block for full tokens and component specs
