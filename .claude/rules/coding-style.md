...
- ESLint must pass with no errors: `npx eslint .`
- Configure in `prettier.config.js` / `eslint.config.js` at project root
- Both tools must be part of CI and pre-commit hooks
