...
(function () {
  ...
  const REGION_GLYPHS = {
    ...
    'Southeast Asia':
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z', // Concentric circles
    Pacific:
      'M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z', // Wave ring
    ...
    'Southern America':
      'M12 2L2 12L12 22L22 12L12 2Z M16 12L12 8L8 12L12 16L16 12Z', // Nested diamonds
    'Central America':
      'M12 2L22 12L12 22L2 12L12 2Z M12 6L18 12L12 18L6 12L12 6Z', // Stepped pyramid shape
    'Middle East':
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z', // Crescent-style
    Nordic: 'M16 2L22 16L16 30L10 16L16 2Z M16 10L12 16L16 22L20 16L16 10Z', // Rune-diamond
    Celtic:
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14l-2-2 2-2 2 2-2 2z', // Knot-style
