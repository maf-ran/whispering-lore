...
- [~] i18n Phase 2 Wave H (in progress): other regions (celtic etc), languages beyond sv — junk scaffold files (`data/i18n/sv/{creatures,stories}-{celtic,east-asian}.json` + `tests/fixtures/sv-{celtic-stories,east-asian-creatures}.json`, 1 fake entry each, English text, nonexistent slugs) DELETED. Real content started: `data/i18n/sv/creatures-celtic.json` = 35/35 celtic creatures complete (name+summary+description sv, gate: slug match x35, desc >=200 chars, 0 Cyrillic-е), manifest.i18n.sv now creatures-celtic+creatures-nordic+items-nordic+stories-nordic. REMAINING: stories-celtic, creatures+stories-east-asian, languages beyond sv
