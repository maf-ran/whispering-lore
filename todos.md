...
- [x] i18n Phase 2 Wave H — Celtic creatures SHIPPED (c42c318): junk scaffold files DELETED. `data/i18n/sv/creatures-celtic.json` = 35/35 complete (gate: slug x35, desc >=200 chars, 0 Cyrillic-е). Gates: jest 222/222, i18n e2e 33/35 (2 GT-cookie failures PRE-EXISTING at HEAD — gemini-proxy 9a86339 removed auto-ensureTranslate restore in language-toggle.js:239/246, `__gtCalls` stays 0; reproduce on pristine-HEAD worktree)
- [x] i18n Phase 2 Wave H — Celtic stories SHIPPED (217baed): region-keyed overlays
- [x] i18n Phase 2 Wave H — East Asia SHIPPED (post-217baed): `creatures-east-asia-and-pacific.json` = 90/90 complete (Japan 44, China 18, S.Korea 12, N.Korea 8, Tibet 5, Taiwan 3; gate slug x90, desc >=200 chars, 0 Cyrillic-е). `stories-east-asia.json` (26) + `stories-east-asia-and-pacific.json` (3 Taiwan) = 29 total, 12 full (top-12 by ft_len, ratios 0.93-1.01) + 17 partial. GOTCHA: region for EA is 'East Asia and Pacific' (creatures) vs 'East Asia'/'East Asia and Pacific' (stories) — NOT a single 'east-asian' region; a merged 'east-asian' file would never load (loader keys by region). Coverage map updated (manifest.i18n.sv +creatures-east-asia-and-pacific, +stories-east-asia, +stories-east-asia-and-pacific). Gates: jest 222/222, eslint 0 err, browser-verified white-snake sv badge-free + taka-ny-d sv desc + tek-ko-kui partial badge. REMAINING: languages beyond sv
