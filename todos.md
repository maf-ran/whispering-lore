...
- [x] i18n Phase 2 Wave H — Celtic creatures SHIPPED (c42c318): junk scaffold files (`data/i18n/sv/{creatures,stories}-{celtic,east-asian}.json` + `tests/fixtures/sv-{celtic-stories,east-asian-creatures}.json`, 1 fake entry each, English text, nonexistent slugs) DELETED. `data/i18n/sv/creatures-celtic.json` = 35/35 celtic creatures complete (name+summary+description sv, gate: slug match x35, desc >=200 chars, 0 Cyrillic-е), manifest.i18n.sv now creatures-celtic+creatures-nordic+items-nordic+stories-nordic. Gates: jest 222/222, i18n e2e 33/35 (2 GT-cookie failures PRE-EXISTING at HEAD — gemini-proxy 9a86339 removed auto-ensureTranslate restore in language-toggle.js:239/246, `__gtCalls` stays 0; reproduce on pristine-HEAD worktree). REMAINING: stories-celtic, creatures+stories-east-asian, languages beyond sv
