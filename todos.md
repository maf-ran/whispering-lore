...
- [ ] i18n Phase 2 Wave B (future): more sv content batches, `complete:true` flag for fully-covered entries (badge policy currently entry-level partial), pre-scan manifest to skip missing overlay 404s, menu arrow-key polish leftovers from P1
