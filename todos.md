...
- [x] i18n Phase 2 Wave H — Celtic stories SHIPPED (recommit after c42c318): `data/i18n/sv/stories-{celtic,irish,scottish,welsh}.json` = ALL 28 celtic-region stories (6 Irish/5 full, 10 Scottish/6 full, 1 Welsh/1 full, 11 Celtic partial = 12 full + 16 partial sv title+summary+full_text complete:true). GOTCHA: loader keys overlays by story REGION (`_loadOverlayFor` fileKey) — a single merged `stories-celtic.json` would only decorate the 11 region:Celtic stories, so split per region (Irish→stories-irish etc); coverage map now sv: creatures-celtic+creatures-nordic+items-nordic+stories-celtic+stories-irish+stories-nordic+stories-scottish+stories-welsh. Gates: jest 222/222, eslint 0 err; browser-verified children-of-lir full sv badge-free + morgan-le-fay partial badge. REMAINING: creatures+stories-east-asian, languages beyond sv
